...
<head>
  ...
  <title>Penjadwalan Mata Kuliah | @yield('location')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-lg" style="font-size:14px;"><b>Penjadwalan </b>Mata Kuliah</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Fakultas Teknik Universitas Bengkulu</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Penjadwalan</a></li>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <a href="https://www.bankbengkulu.co.id/" target="_blank"><b>Penjadwalan Mata Kuliah</b></a>
    </div>
